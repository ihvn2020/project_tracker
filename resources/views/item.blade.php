...
<div class="container">
    <div class="row">
        <div class="card col m8 offset-m2" style="margin-top:20px; padding: 35px;">
            <div>
              <a href="/print_item/{{$item->id}}" class="btn btn-small btn-floating right green pulse tooltipped"  data-position="top" data-tooltip="Print this Item" ><i class="material-icons">printer</i></a>
            </div>

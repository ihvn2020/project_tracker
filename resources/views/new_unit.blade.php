        ...
        <div class="card col m6 offset-m3" style="margin-top:20px;">
                ...
                <h3 class="card-header text-center" style="text-align:center;">Add New Unit</h3>
                    ...
                    <form method="POST" action="{{ route('units.store') }}">
                        ...
                        <div class="input-field">
                                <select name="facility" id="facility" class="browser-default"  materialize="material_select">
                        ...
                        <div class="input-field">
                                <select name="department" id="department" class="browser-default"  materialize="material_select">
